...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Start free with 1,000 DMs per month. Upgrade to Pro for unlimited automation.',
    type: 'website',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Pricing Plans - LogicDM',
    description: 'Start free with 1,000 DMs per month. Simple, transparent pricing.',
  },
};
